...
├── 04-milesymedia-portal/             ← the next-gen agency platform
...
- **`03 old portal/old-portal-github/`** — the v9 monorepo with the
  ...
  is stubbed.
- **`04-milesymedia-portal/clients/felicias perfect portal/`** — file
  snapshot of Felicia's site at the point we shipped it to her.

## What's next

The next-gen agency platform gets built inside `04-milesymedia-portal/`.
