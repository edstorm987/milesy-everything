/* AquaAI — scripted companion (no API). Single source of truth for the
   ...
   BOS (`../incubator app/lib/aqua-ai.js`). Real Claude API wires later
   via T6.
  ...
  var REPLIES = [
    ...
    { kw: ['diagnostics phase', 'health check phase'],
      ...
      actions: [
        ...
        { label: 'Run the Health Check', href: '../lead magnet app/index.html', kind: 'open' }
      ] },
    ...
    { kw: ['stuck', 'frozen', 'i don\'t know', 'don\'t know what', 'help me'],
      ...
      actions: [
        { label: 'Run the Health Check', href: '../lead magnet app/index.html', kind: 'open' },
        { label: 'Open About my business', href: '../business-os app/company.html', kind: 'open' },
        { label: 'Open Core Principles', href: '../business-os app/module.html?id=core-principles', kind: 'lesson' }
      ] },
    ...
    { kw: ['where to start', 'start here', 'first step', 'beginning'],
      ...
      actions: [{ label: 'Run the Health Check', href: '../lead magnet app/index.html', kind: 'open' }] },
    ...
    { kw: ['what next', 'whats next', 'next move', 'next action'],
      ...
      actions: function (ctx) {
        if (!ctx.hc) return [{ label: 'Run the Health Check', href: '../lead magnet app/index.html', kind: 'open' }];
    ...
    { kw: ['done with', 'finished my'],
      ...
      actions: [{ label: 'Browse modules', href: '../business-os app/database.html', kind: 'open' }] },
    ...
    { kw: ['biggest leak', 'worst score', 'lowest score'],
      ...
      actions: function (ctx) { return ctx.hc ? [{ label: 'See your top-3 next moves', href: 'index.html', kind: 'open' }] : [{ label: 'Run the Health Check', href: '../lead magnet app/index.html', kind: 'open' }]; } },
    ...
    { kw: ['health check', 'hc result', 'my hc', 'my score'],
      ...
      actions: function (ctx) { return ctx.hc ? [{ label: 'See your recommendations', href: 'index.html', kind: 'open' }] : [{ label: 'Run the Health Check', href: '../lead magnet app/index.html', kind: 'open' }]; } },
    ...
    { kw: ['rerun', 're-run', 'do again', 'redo health'],
      ...
      actions: [{ label: 'Re-run the Health Check', href: '../lead magnet app/index.html', kind: 'open' }] },
    ...
    { kw: ['which module', 'which lesson', 'recommend module', 'first lesson'],
      ...
      actions: [
        { label: 'Open Core Principles', href: '../business-os app/module.html?id=core-principles', kind: 'lesson' },
        { label: 'Browse all modules', href: '../business-os app/database.html', kind: 'open' }
      ] },

    { kw: ['core principles'],
      reply: 'Core Principles covers the fundamental lever: positioning. Read it slowly — most clients re-read after Diagnostics.',
      actions: [{ label: 'Open Core Principles', href: '../business-os app/module.html?id=core-principles', kind: 'lesson' }] },
    ...
    { kw: ['super sales', 'sales lesson', 'website conversion'],
      ...
      actions: [{ label: 'Open Super Sales', href: '../business-os app/module.html?id=super-sales', kind: 'lesson' }] },
    ...
    { kw: ['referral', 'word of mouth'],
      ...
      actions: [{ label: 'Open Referral Alchemy', href: '../business-os app/module.html?id=referral-alchemy', kind: 'lesson' }] },
    ...
    { kw: ['ops', 'sustainability', 'systems', 'delegate'],
      ...
      actions: [{ label: 'Open Ops & Sustainability', href: '../business-os app/module.html?id=ops-sustainability', kind: 'lesson' }] },
