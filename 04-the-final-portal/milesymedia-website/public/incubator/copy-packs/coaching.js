...
(function () {
  ...
  window.IncubatorCopyPacks.coaching = {
    ...
    moduleHighlight: [
      { icon: '✍️', label: 'Niche down without shrinking', href: '../business-os/module.html?id=core-principles' },
      { icon: '📝', label: 'High-ticket sales call frame',  href: '../business-os/module.html?id=super-sales' },
      { icon: '🗓', label: 'Group + 1:1 delivery cadence',  href: '../business-os/module.html?id=ops-sustainability' },
      { icon: '💬', label: 'Client → testimonial → referral', href: '../business-os/module.html?id=referral-alchemy' }
    ],
    faqs: [
