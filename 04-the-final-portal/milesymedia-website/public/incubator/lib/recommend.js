...
(function () {
  ...
  var TOPIC_MAP = {
    'Visibility & Search': {
      ...
      deepLinkTo: { kind: 'lesson', label: 'Open Core Principles', href: '../business-os/module.html?id=core-principles' }
    },
    'Your Website': {
      ...
      deepLinkTo: { kind: 'lesson', label: 'Open Super Sales', href: '../business-os/module.html?id=super-sales' }
    },
    ...
    'Keeping Them': {
      ...
      deepLinkTo: { kind: 'lesson', label: 'Open Referral Alchemy', href: '../business-os/module.html?id=referral-alchemy' }
    }
  };
