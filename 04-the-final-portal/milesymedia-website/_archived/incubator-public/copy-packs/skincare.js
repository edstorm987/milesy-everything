...
(function () {
  ...
  window.IncubatorCopyPacks.skincare = {
    ...
    moduleHighlight: [
      { icon: '🌿', label: 'Ingredient storytelling',    href: '../business-os/module.html?id=core-principles' },
      { icon: '🛍', label: 'Product page that converts', href: '../business-os/module.html?id=super-sales' },
      { icon: '🔁', label: 'Repeat-purchase ritual',     href: '../business-os/module.html?id=ops-sustainability' },
      { icon: '📸', label: 'UGC + creator referrals',    href: '../business-os/module.html?id=referral-alchemy' }
    ],
    faqs: [
