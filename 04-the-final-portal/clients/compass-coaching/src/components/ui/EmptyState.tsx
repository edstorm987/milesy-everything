...
export function EmptyState({ heading, body, icon, cta, secondaryCta, className }: EmptyStateProps) {
  return (
    <div className={["flex flex-col items-center justify-center gap-3 rounded-md border border-dashed border-black/15 bg-white/60 px-6 py-10 text-center", className ?? ""].join(" ")}>
