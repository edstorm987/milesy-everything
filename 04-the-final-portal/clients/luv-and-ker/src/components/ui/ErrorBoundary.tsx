...
// ErrorBoundary — friendly fallback for render-time crashes. React 19
// still requires a class component for boundaries.
...
export class ErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, info: ErrorInfo): void {
    if (typeof console !== "undefined") {
      console.error(`[Luv & Ker · ErrorBoundary${this.props.label ? ` · ${this.props.label}` : ""}]`, error, info.componentStack);
    }
  }
