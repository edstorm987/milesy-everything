...
(function () {
  ...
  window.IncubatorCopyPacks.fitness = {
    ...
    moduleHighlight: [
      { icon: '💪', label: 'Programme architecture',     href: '../business-os app/module.html?id=core-principles' },
      { icon: '🎟', label: 'Trial → member conversion',  href: '../business-os app/module.html?id=super-sales' },
      { icon: '🔁', label: 'Retention + attendance',     href: '../business-os app/module.html?id=ops-sustainability' },
      { icon: '🤝', label: 'Member → friend referral',   href: '../business-os app/module.html?id=referral-alchemy' }
    ],
    faqs: [
