...
export type IntegrationsEventName =
  | "integrations.integration.created"
  | "integrations.integration.updated"
  | "integrations.integration.configured"
  | "integrations.integration.verified"
  | "integrations.integration.failed"
  | "integrations.integration.deleted"
  | "integrations.webhook.incoming"
  | "integrations.webhook.outgoing";

export interface EventBusPort {
  emit<T = unknown>(
    scope: { agencyId: AgencyId; clientId?: ClientId },
    name: IntegrationsEventName | string,
    payload: T,
  ): void;
}
