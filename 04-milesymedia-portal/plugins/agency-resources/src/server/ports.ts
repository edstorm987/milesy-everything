...
export type AgencyResourcesEventName =
  | "agency-resources.resource.created"
  | "agency-resources.resource.updated"
  | "agency-resources.resource.archived"
  | "agency-resources.resource.viewed";

export interface EventBusPort {
  emit<T = unknown>(
    scope: { agencyId: AgencyId; clientId?: ClientId },
    name: AgencyResourcesEventName | string,
    payload: T,
  ): void;
}
