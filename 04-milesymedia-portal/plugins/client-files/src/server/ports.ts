...
export type ClientFilesEventName =
  | "client-files.file.uploaded"
  | "client-files.file.deleted"
  | "client-files.file.share_link_issued"
  | "client-files.file.share_link_revoked";

export interface EventBusPort {
  emit<T = unknown>(
    scope: { agencyId: AgencyId; clientId?: ClientId },
    name: ClientFilesEventName | string,
    payload: T,
  ): void;
}
